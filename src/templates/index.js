...
export const TEMPLATES = {
    ...
    'dotnet-community-standup': {
        ...
        fields: [
            ...
            },
            {
                ...
                placeholder: 'e.g., Jane Doe, John Smith or Jane Doe + John Smith',
                maxLength: 120,
    ...
    'on-dotnet-live': {
        id: 'on-dotnet-live',
        name: 'On .NET Live',
        description: 'Show thumbnails with title, guest(s), and schedule',
        fields: [
            {
                id: 'title',
                type: FIELD_TYPES.TEXT,
            ...
            },
            {
                ...
                maxLength: 60,
                showWhen: { field: 'guestCount', equals: '2' },
            },
            {
                id: 'day',
                type: FIELD_TYPES.TEXT,
            ...
            },
            {
                ...
                type: FIELD_TYPES.TEXT,
                label: 'Time',
                placeholder: 'e.g., 9:00 AM PST (16:00)',
                maxLength: 40,
            },
            {
                id: 'guests',
                type: FIELD_TYPES.IMAGE_ARRAY,
                label: 'Guest Photos',
                helperText: 'Upload 1–2 guest headshots (mask/clip path is applied by the SVG)',
                maxItems: 2,
