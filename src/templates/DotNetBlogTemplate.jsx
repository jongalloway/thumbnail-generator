...
export function DotNetBlogTemplate({
  ...
  const generateSvg = useCallback(() => {
    ...
    // Calculate subtitle position first (bottom-aligned)
    ...
    // Auto-size title font to fit available vertical space
    const titleMaxFontSize = 133 * scale
    const titleMinFontSize = 70 * scale
    const titleBottomLimit = subtitle
      ? subtitleY - subtitleFontSize - (20 * scale)
      : height - edgeMarginY
